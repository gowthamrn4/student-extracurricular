...
$insert=mysql_query("insert into nss(no,name,rollno,image,class,email,phone,joind,address)values('$no','$name','$rollno','$second','$class','$email','$phone','$joind','$address')");
}
if($insert)
{
...
<div class="menu">
        <ul>
          <li><a href="view1.php" class="active"><span>View</span></a></li>
