...
if($_GET['del'])
{
$delete=mysql_query("delete from ncc where name='".$_GET['del']."'");
if($delete>0)
{
...
echo $row['image']; ?>" alt="<?php echo $row['name'];?>" width="100" height="100" style="border-top-color:#FF0000">
 ...
 <?PHP
$select=mysql_query("select * from ncc ");
$view=mysql_num_rows($select);
 ...
 <tr>
    ...
    <td align="center"><a href="view2.php?edit=<?php echo mysql_result($select,$i,"name");?>">View</a>
...
<div class="menu">
        <ul>
          <li ><a href="logout.php"class="active"><span>Log Out</span></a></li>
